...
FlashObject = function(swf, id, w, h, ver, c) {
	...
	this.altTxt = "<p>You need <a href='http://www.macromedia.com/go/getflashplayer'>Flash Plugin</a><br />to enjoy this feature.</p>";
	this.bypassTxt = "<p>Already have Flash Player?<br /><a href='?detectflash=false&"+ this.sq +"'>Click here if you have Flash "+ this.version +" installed</a>.</p>";
